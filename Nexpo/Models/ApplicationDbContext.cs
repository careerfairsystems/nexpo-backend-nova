...
namespace Nexpo.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public void Seed()
        {
            ...
            var event8 = new Event { Id = -8, Name = "The final banquet", Description = "The final banquet for all volunteers, company hosts, and company reps", Date = DateTime.Now.AddDays(15).Date.ToString(), Start = "12:15", End = "13:00", Host = "Teknologkåren", Location = "Hänget", Language = "English", Capacity = 300};

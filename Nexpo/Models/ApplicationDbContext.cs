...
namespace Nexpo.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public void Seed()
        {
            ...
            // Events
            var event1 = new Event { Id = -1, Name = "Breakfast Mingle",            Type = "company event", Description = "Breakfast with SEB",                                       Date = DateTime.Now.AddDays(10).Date.ToString(), Start = "08:15", End = "10:00", Host = "SEB",           Location = "Cornelis",     Language = "Swedish", Capacity = 30 };
            var event2 = new Event { Id = -2, Name = "Bounce with Uber",            Type = "company event", Description = "Day event at Bounce with Uber",                            Date = DateTime.Now.AddDays(11).Date.ToString(), Start = "09:00", End = "16:00", Host = "Uber",          Location = "Bounce Malmö", Language = "English", Capacity = 20 };
            var event3 = new Event { Id = -3, Name = "CV Workshop with Randstad",   Type = "company event", Description = "Make your CV look professional with the help of Randstad", Date = DateTime.Now.AddDays(12).Date.ToString(), Start = "13:30", End = "15:00", Host = "Randstad",      Location = "E:A",          Language = "Swedish", Capacity = 3 };
            var event4 = new Event { Id = -4, Name = "Inspirational lunch lecture", Type = "company event", Description = "Get inspired and expand your horizons",                    Date = DateTime.Now.AddDays(14).Date.ToString(), Start = "12:15", End = "13:00", Host = "SYV",           Location = "MA:3",         Language = "Swedish", Capacity = 2 };
            var event5 = new Event { Id = -5, Name = "Pick apples with Apple",      Type = "company event", Description = "An apple a day keeps the doctor away",                     Date = DateTime.Now.AddDays(1).Date.ToString(),  Start = "12:15", End = "13:00", Host = "Apple",         Location = "M:B",          Language = "English", Capacity = 200};

            var event6 = new Event { Id = -6, Name = "Lunch For volunteers",        Type = "lunch",         Description = "A lunch for all volunteers to enjoy",                      Date = DateTime.Now.AddDays(15).Date.ToString(), Start = "12:15", End = "13:00", Host = "Teknologkåren", Location = "Hänget",   Language = "Swrdish", Capacity = 300};
            var event7 = new Event { Id = -7, Name = "Lunch For Company Rep!",      Type = "lunch",         Description = "Com.reps get hungry aswell",                               Date = DateTime.Now.AddDays(15).Date.ToString(), Start = "12:15", End = "13:00", Host = "Teknologkåren", Location = "Perstorp", Language = "English", Capacity = 500};

            var event8 = new Event { Id = -8, Name = "The final banquet",           Type = "lunch",         Description = "The final banquet for all volunteers, company hosts, and company reps", Date = DateTime.Now.AddDays(15).Date.ToString(), Start = "12:15", End = "13:00", Host = "Teknologkåren", Location = "Hänget", Language = "English", Capacity = 300};

...
namespace Nexpo.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public void Seed()
        {
            ...
            var event5 = new Event { Id = -5, Name = "Pick apples with Apple", Description = "An apple a day keeps the doctor away", Date = DateTime.Now.ToString(), Start = "12:15", End = "13:00", Host = "Apple", Location = "M:B", Language = "English", Capacity = 200};
